        ...
        <div class="card bg-dark">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-dark table-sm w-100" id="ahero_table">
                        <thead>
                            <tr>
                                <th>Image</th>
                                <th>Name</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-outline-light" href="dev.edit.ahero.php?id=<?php echo $rows['id']; ?>" title="Edit"><i class="fas fa-pen"></i></a>
                                        <?php if ($rows['status'] == 'Published') { ?>
                                            <a class="btn btn-sm btn-outline-light" href="process.status.ahero.php?id=<?php echo $rows['id']; ?>&status=Unpublish" title="Unpublish">
                                                <i class="fas fa-times"></i>
                                            </a>
                                        <?php } else { ?>
                                            <a class="btn btn-sm btn-outline-light" href="process.status.ahero.php?id=<?php echo $rows['id']; ?>&status=Published" title="publish">
