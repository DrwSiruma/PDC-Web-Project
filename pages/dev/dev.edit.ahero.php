...
?>
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
        ...
        <div class="container">
            <?php if (!empty($_SESSION['ahero-error'])) : ?>
                <div class="alert alert-danger"><?php echo $_SESSION['ahero-error']; unset($_SESSION['ahero-error']); ?></div>
            <?php endif; ?>
            <?php if (!empty($_SESSION['ahero-success'])) : ?>
                <div class="alert alert-success"><?php echo $_SESSION['ahero-success']; unset($_SESSION['ahero-success']); ?></div>
            <?php endif; ?>

            <form method="post" action="process.edit.ahero.php" enctype="multipart/form-data">
